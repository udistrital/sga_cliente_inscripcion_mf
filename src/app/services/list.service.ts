...
import { REDUCER_LIST } from "../utils/reducers/reducer.constants";
...
import { CIDCService } from "./cidc.service";
import { EnteService } from "./ente.service";
import { DescuentoAcademicoService } from "./descuento_academico.service";
import { DocumentoProgramaService } from "./documento_programa.service";
import { Store } from "@ngrx/store";
import { IAppState } from "../utils/reducers/app.state";
...
export class ListService {
  ...
  private addList(type: string, object: any) {
    this.store.dispatch({
      type: type,
      payload: object,
    });
