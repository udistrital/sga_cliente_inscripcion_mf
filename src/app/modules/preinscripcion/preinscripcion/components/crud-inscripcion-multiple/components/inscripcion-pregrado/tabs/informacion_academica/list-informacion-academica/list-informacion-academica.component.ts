...
export class ListInformacionAcademicaComponent {
  ...
  ngOnInit() {
    ...
    // this.calculatePercentage(); // Calcula el porcentaje inicial
  }

  // Método para calcular el porcentaje basado en la cantidad de formularios válidos
  calculatePercentage() {
    const totalForms = 6;
    let validForms = 0;
    ...
    console.log("AAAAAAAAAAAAAAAAAAAAAA",validForms)
    this.result.emit(percentage); // Emitir el porcentaje de avance
  }
