...
export const environment = {
  ...
  EXPERIENCIA_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/experiencia_laboral_crud/v2/',
  ...
  SGA_CALENDARIO_MID_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/calendario_mid/v2/',
  // SGA_CALENDARIO_MID_SERVICE: 'http://127.0.0.1:8545/v1/',
  SGA_INSCRIPCION_MID_SERVICE: 'https://autenticacion.portaloas.udistrital.edu.co/apioas/inscripcion_mid/v1/',
  // SGA_INSCRIPCION_MID_SERVICE: 'http://localhost:8543/v1/',
